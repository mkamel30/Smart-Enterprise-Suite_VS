...
if not exist ".env" (
    ...
    (
        ...
        echo.
        echo # Database
        echo DATABASE_URL="postgresql://postgres:postgres@127.0.0.1:5433/smart_enterprise?schema=public"
        echo.
        echo # JWT
...
if !errorlevel! equ 0 (
    echo ⚠️  Port 5002 (Backend) is already in use
...
echo    - Port 5433 will be used for PostgreSQL
