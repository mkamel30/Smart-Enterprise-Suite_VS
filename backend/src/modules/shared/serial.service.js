...
async function ensureSerialNotAssignedToCustomer(serialNumber) {
    ...
    if (existing) {
        const branchName = existing.customer?.branch?.name || existing.customer?.branchId || existing.branchId || '��� ����';
        const message = `�������� ��������� ${serial} ����� ������ ��� ������ ${existing.customer?.client_name || existing.customerId} �� ��� ${branchName}`;
