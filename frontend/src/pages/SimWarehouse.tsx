        ...
        <div className="px-4 lg:px-8 pt-4 pb-8 animate-fade-in bg-gradient-to-br from-slate-50 to-blue-50/30 min-h-screen" dir="rtl">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-8">
                <h1 className="text-3xl font-black text-primary flex items-center gap-3">
                    ...
                    {isAffairs ? 'المخزن الرئيسي للشرائح' : 'مخزن الشرائح'}
                </h1>
                    ...
                    {selectedSims.size > 0 && isAffairs ? (
                        ...
                        <>
                            <button
                                ...
                                className="flex-1 lg:flex-none flex items-center justify-center gap-2 px-6 py-2.5 bg-gradient-to-r from-[#7E5BAB] to-[#7E5BAB]/90 text-white rounded-xl font-black shadow-lg hover:opacity-90 transition-all active:scale-95"
                            >
                                <Plus size={18} />
